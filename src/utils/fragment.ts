...
export function getPageFragment(
    page: Fragment,
    scope: Pick<RenderScope, 'dependencyMap' | 'importExtension' | 'kitImportStrategy'>,
): Fragment {
    ...
    const imports =
        page.imports.size === 0
            ? undefined
            : fragment`${importMapToString(page.imports, scope.dependencyMap, scope.kitImportStrategy, scope.importExtension)}`;
