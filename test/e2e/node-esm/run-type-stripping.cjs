...
// Runs `compatibility.ts` through Node's type stripping, which only exists from Node
...
const result = spawnSync(process.execPath, [path.join(__dirname, 'compatibility.ts')], { stdio: 'inherit' });
