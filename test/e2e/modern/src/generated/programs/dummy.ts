...
export const DummyInstruction: Omit<typeof DummyInstructionLookup, number> = DummyInstructionLookup;

export type DummyInstruction = (typeof DummyInstruction)[keyof typeof DummyInstruction];
...
export type ParsedDummyInstruction<TProgram extends string = 'Dummy1111111111111111111111111111111111'> =
    | ({ instructionType: typeof DummyInstruction.Instruction1 } & ParsedInstruction1Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction2 } & ParsedInstruction2Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction3 } & ParsedInstruction3Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction4 } & ParsedInstruction4Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction5 } & ParsedInstruction5Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction6 } & ParsedInstruction6Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction7 } & ParsedInstruction7Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction8 } & ParsedInstruction8Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction9 } & ParsedInstruction9Instruction<TProgram>)
    | ({ instructionType: typeof DummyInstruction.Instruction10 } & ParsedInstruction10Instruction<TProgram>);
