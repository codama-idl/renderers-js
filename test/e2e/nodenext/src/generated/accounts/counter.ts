...
import { findCounterPda, type CounterSeeds } from '../pdas/index.js';
import {
    getCounterValueDecoder,
    getCounterValueEncoder,
    type CounterValue,
    type CounterValueArgs,
} from '../types/index.js';

export type Counter = { value: CounterValue };

export type CounterArgs = { value: CounterValueArgs };

/** Gets the encoder for {@link CounterArgs} account data. */
export function getCounterEncoder(): FixedSizeEncoder<CounterArgs> {
    return getStructEncoder([['value', getCounterValueEncoder()]]);
}

/** Gets the decoder for {@link Counter} account data. */
export function getCounterDecoder(): FixedSizeDecoder<Counter> {
    return getStructDecoder([['value', getCounterValueDecoder()]]);
}
